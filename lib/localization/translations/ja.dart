const Map<String, String> jaText = {
  ...
  'premiumEnabled': 'Premiumを有効化しました。広告は表示されません。',
  'premiumDisabled': 'Premiumを無効化しました。広告が再表示される場合があります。',
  'rewardUnlocked24h': '報酬を獲得しました。24時間広告なしです。',
  'interstitialAdPlaceholder': 'インタースティシャル広告（ダミー）: {source}',
  'closeAd': '広告を閉じる',
  'premiumNoAdsTitle': 'Premium（広告なし）',
  'premiumNoAdsSubtitle': '現状はシミュレーション用の切り替えです',
  'adFreeUntil': '広告なし有効期限: {until}',
  'adFreeRewardInactive': '広告なし報酬は未有効です',
